...
const star = textureLoader.load(myStar); // const normalTexture = textureLoader.load("");
// Debug
...
let moon = myMoon;
loader.load(moon, function (gltf) {
  moon = gltf.scene;
  moon.rotation.y = -0.3;
  moon.rotation.x = -0.2;
...
scene.add(pointLight3); // const light3 = gui.addFolder("Light 3");
